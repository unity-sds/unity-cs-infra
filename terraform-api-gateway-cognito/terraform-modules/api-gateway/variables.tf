...
variable "ssm_param_api_gateway_integration_uds_granules_dapa_function_uri" {
  type        = string
  description = "SSM Param for UDS Granules DAPA Function URI"
  default     = "/unity/unity-ds/api-gateway/integrations/granules-dapa-function-uri"
}

variable "ssm_param_api_gateway_integration_uds_collections_dapa_function_uri" {
  type        = string
  description = "SSM Param for UDS Collections DAPA Function URI"
  default     = "/unity/unity-ds/api-gateway/integrations/collections-dapa-function-uri"
}

variable "ssm_param_api_gateway_integration_uds_collections_ingest_dapa_function_uri" {
  type        = string
  description = "SSM Param for UDS Collections Ingestion DAPA Function URI"
  default     = "/unity/unity-ds/api-gateway/integrations/collections-ingest-dapa-function-uri"
}

variable "ssm_param_api_gateway_integration_uds_collections_create_dapa_function_uri" {
  type        = string
  description = "SSM Param for UDS Collections Creation DAPA Function URI"
  default     = "/unity/unity-ds/api-gateway/integrations/collections-create-dapa-function-uri"
}
